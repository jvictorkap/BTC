...
def get_file_saldo_btc():
    ...
    email_gmail.get_mail_files(['luiz.silva@kapitalo.com.br'],f"Disponibilidade BTC - {dt_1.strftime('%d/%m/%Y')}",'G://Trading//K11//Python//Aluguel//Saldo_BTC//', [".xls", ".xlsm", ".xlsx"],'Saldo_BTC',att_newer_than=8)
...
def main():
    ...
    df=pd.read_excel(f"G://Trading//K11//Python//Aluguel//Saldo_BTC//Saldo_BTC_trade_{today.strftime('%Y%m%d')}.xlsx")
