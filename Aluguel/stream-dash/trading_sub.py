...
def boleta_sub(df:pd.DataFrame):
    df.rename(columns={'corretora':'str_corretora','vencimento':'dte_datavencimento', 
                        'codigo':'str_papel','quantidade':'dbl_quantidade','taxa': 'dbl_taxa'}, inplace=True)
    ...
    return df[["str_fundo", "str_corretora", "str_tipo",
               ...
               'str_tipo_registro',"str_modalidade" ,'str_tipo_comissao',"dbl_valor_fixo_comissao",'str_papel',"dbl_quantidade"]] 
