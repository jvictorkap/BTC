...
for i in boleta_renov.index:
    ...
    VALUES{'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s'}""" %(boleta_renov['registro'],boleta_renov['cliente'],boleta_renov['corretora'],boleta_renov['tipo'],boleta_renov['vencimento'],boleta_renov['taxa'],boleta_renov['cotliq'],boleta_renov['reversor'],boleta_renov['codigo'],boleta_renov['contrato'],boleta_renov['saldo'],boleta_renov['Quantidade'],boleta_renov['taxa final'],boleta_renov['Vencimento'],boleta_renov['Troca?'],boleta_renov['tipo_registro'],boleta_renov['Modalidade'],boleta_renov['Tipo de Comissão'],boleta_renov['Valor fixo com'])
