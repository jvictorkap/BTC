...
def main():
    ...
    df['att']=df.apply(lambda row: True if (row['str_tipo']=='D' and row['position']>0) else True if (row['str_tipo']=='T' and  row['to_borrow_3']!=0) else False ,axis=1)
    print(df)    
