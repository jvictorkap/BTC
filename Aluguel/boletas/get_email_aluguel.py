...
def get_email_bofa():
    email_gmail.get_mail_files(['eduardo.montoro@bofa.com','leonardo.borelli@bofa.com'],'','G://Trading//K11//Aluguel//Trades//Bofa//', [".xls", ".xlsm", ".xlsx"],'AluguelBofa',
                               att_newer_than=8)
...
def get_email_itau():
    email_gmail.get_mail_files(['carolina.casseb@itaubba.com'],'','G://Trading//K11//Aluguel//Trades//Itau//', [".xls", ".xlsm", ".xlsx"],'AluguelItau',att_newer_than=8)
